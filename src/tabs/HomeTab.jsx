...
const DEFAULT_PASTURES = [
  { id: 'p1', name: 'North 80', acres: 80, head: 45, species: 'cattle', condition: 'Good', grazeDays: 18, totalDays: 21, resting: false },
  { id: 'p2', name: 'South Creek', acres: 160, head: 0, species: 'cattle', condition: 'Fair', grazeDays: 12, totalDays: 35, resting: true },
  { id: 'p3', name: 'Highway', acres: 40, head: 22, species: 'cattle', condition: 'Good', grazeDays: 5, totalDays: 21, resting: false },
  { id: 'p4', name: 'East Pasture', acres: 120, head: 34, species: 'sheep', condition: 'Good', grazeDays: 8, totalDays: 14, resting: false },
];
